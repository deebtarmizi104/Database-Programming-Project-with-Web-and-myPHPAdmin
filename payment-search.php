...
if(isset($_POST['searchPayment']))
{
    ...
    $search_Query = "SELECT fName, lName, total from Customer c, Payment p, Booking b
                     where c.cust_ID = b.cust_ID AND b.booking_ID = p.booking_ID
                    AND c.cust_id = '$data[0]' ";

    $search_Result = mysqli_query($connect, $search_Query);

    echo "<table class='data-table' style='border: solid 1px black;' align='center'>";
    echo "<tr><th>First Name</th><th>Last Name</th><th>Total (RM)</th></tr>";
...
<body>
    ...
    <!-- Start Shop Page  --><br><br><br>
      <div id="div 1" style="text-align: center;" >
            <p>Search for payment by customer ID</p>
              <form action="payment-search.php" method="post">
                <input type="text" name="cid" placeholder="Enter customer ID" value="<?php echo $cid;?>"><br><br>
                <br>

                  <div>
                      <div class="submit-button text-center">
                        <input type="submit" name="searchPayment" value="Find">
