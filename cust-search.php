...
<body>
    ...
    <!-- Start Shop Page  --><br><br><br>
      <div id="div 1" style="text-align: center;" >
            <p>Three First Customer in the Database</p>
            <form action="cust-search.php" method="post">
              <div name="showList">
                    ...
                    <input type="submit" name="showList" value="Show">
                      <div id="msgSubmit" class="h3 text-center hidden">
                        ...
                        if(isset($_POST['showList']))
                        {
                            ...
                            $search_Query = "SELECT cust_ID, fName FROM Customer LIMIT 3";

                            $search_Result = mysqli_query($connect, $search_Query);

                            echo "<table class='data-table' style='border: solid 1px black;' align='center'>";
                            echo "<tr><th>Customer ID</th><th>First Name</th></tr>";
                            ...
                            if($search_Result)
                            {
                                    while($row = mysqli_fetch_array($search_Result))
                                    {
                                      ...
                                      echo nl2br ("<tr><td>{$cid}</td><td>{$fname}</td></tr>");
                                    }
