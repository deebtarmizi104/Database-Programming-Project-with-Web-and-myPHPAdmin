...
{
    $data = getmname();
    $delete_Query = "DELETE FROM Movie where movie_name = '$data[0]' ";
...
<body>
    ...
    <!-- Start Shop Page  --><br><br><br>
      <div id="div 1" style="text-align: center;" >
            <p>Delete Movie from Movie Name</p>
              ...
              <br>
                ...
                <div>
                    <div class="submit-button text-center">
                      <input type="submit" name="deleteMovie" value="Delete"><br><br>
                        <div id="msgSubmit" class="h3 text-center hidden">
                          ...
                          if($delete_Result)
                          {
                                    ...
                                    {
                                        echo mysqli_affected_rows($connect) . ' data deleteded.';
                                    }else{
    ...
    <button class="w3-button w3-white"><a class="nav-link" href="movie.php">Return to Movie Info</a></button>
