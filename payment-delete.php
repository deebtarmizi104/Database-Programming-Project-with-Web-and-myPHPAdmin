...
// {
//     $data = getmname();
//     $delete_Query = " CALL deletePayment('$data[0]') ";
//     $delete_Result = mysqli_query($connect, $delete_Query);
//
//         echo "<div id='msgSubmit' class='h3 text-center hidden'>";
//
//         if($delete_Result)
//         {
//             if(mysqli_affected_rows($connect) > 0)
//             {
//                 echo mysqli_affected_rows($connect) . ' Data Deleted.';
//             }else{
...
<body>
    ...
    <!-- Start Shop Page  --><br><br><br>
      <div id="div 1" style="text-align: center;" >
            <p>Delete Payment from Movie Name</p>
