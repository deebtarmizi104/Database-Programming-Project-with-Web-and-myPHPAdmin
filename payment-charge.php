...
<body>
    ...
    <!-- Start Shop Page  --><br><br><br>
      <div id="div 1" style="text-align: center;" >
              <p>Find Total Bill with Charge</p>
                ...
                <br>
                  ...
                  <div>
                      <div class="submit-button text-center">
                        <input type="submit" name="searchCharge" value="Search">
                          <div id="msgSubmit" class="h3 text-center hidden">
                            <?php
                            if(isset($_POST['searchCharge']))
                            {
                                $data = getCid();

                                // $search_Query1 = "SELECT cust_id from customer
	                              //                  where customer.cust_id = $data[0] ";
                                //
                                // $search_Result1 = mysqli_query($connect, $search_Query1);

                                $search_Query = "SELECT method, total from payment natural join booking natural join customer
	                                                where cust_id = $data[0] ";
                                ...
                                if($search_Result)
                                {
                                  if(mysqli_num_rows($search_Result))
                                  {
                                    ...
                                    while($row = mysqli_fetch_array($search_Result))
                                    {
                                        ...
                                        $newbill = $total + $charge;

                                        echo "The new bill is RM" . $newbill;
