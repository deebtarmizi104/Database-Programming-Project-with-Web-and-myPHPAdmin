...
<h3 class="w3-center">MOVIES</h3>
    <!-- Start Shop Page  --><br>
      <div id="div" style="text-align: center;" >
              ...
              <?php
              echo "<tr><th>Movie ID</th><th>Movie Name</th><th>Movie Language</th><th>Release Date</th><th>Director Name</th></tr>";
              ...
              <br>
              <button class="button"><a class="nav-link" href="movie-search.php">Search Movie</a></button>
              <button class="button"><a class="nav-link" href="movie-insert.php">Insert New Movie</a></button>
              <button class="button"><a class="nav-link" href="movie-update.php">Update Movie Info</a></button>
              <button class="button"><a class="nav-link" href="movie-delete.php">Delete Movie Info</a></button>
              <br><br>
      </div>
    <!-- End Shop Page -->
