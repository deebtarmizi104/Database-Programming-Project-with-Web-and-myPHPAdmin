...
if(isset($_POST['3DGlass']))
{
    $data = getCid();

    $search_Query = "SELECT membership from customer
...
<body>
    ...
    <!-- Start Shop Page  --><br><br><br>
      <div id="div 1" style="text-align: center;" >
            <p>Search for 3D Glasses Elligibility</p>
            <form action="cust-3D.php" method="post">
              <input type="text" name="cid" placeholder="Enter customer ID" value="<?php echo $cid;?>"><br><br>
              <br>

                <div>
                    <div class="submit-button text-center">
                      <input type="submit" name="3DGlass" value="Search">
                          ...
                          if($search_Result)
                          {
                            if(mysqli_num_rows($search_Result))
                            {
                                ...
                                if($membership == "Member"){
                                  echo 'The 3D glasses is provided.';
                                }
                                else{
                                  echo 'The 3D glasses is not provided.';
                                }
